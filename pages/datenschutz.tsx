    ...
    <div className="bg-white">
      <main className="py-10 max-w-5xl mx-auto">
        ...
        <div className="mt-6 text-gray-500 space-y-6">
          ...
          <h3 className="text-lg text-gray-900 font-extrabold tracking-tight sm:text-xl">
            Allgemeine Hinweise
          </h3>{" "}
          ...
          <h4 className="text-md text-gray-900 font-extrabold tracking-tight sm:text-lg">
          ...
          <p className="text-base leading-7">
            ...
            Plausible verwendet Technologien, die die seiten&uuml;bergreifende
            Wiedererkennung des Nutzers zur Analyse des Nutzerverhaltens
            erm&ouml;glichen (z.&nbsp;B. Cookies oder Device-Fingerprinting).
            Die durch Plausible erfassten Informationen &uuml;ber die Benutzung
            dieser Website werden auf unserem Server gespeichert. Die IP-Adresse
            wird vor der Speicherung anonymisiert.
          </p>{" "}
          <p className="text-base leading-7">
            Mit Hilfe von Plausible sind wir in der Lage Daten &uuml;ber die
          ...
          <p className="text-base leading-7">
            Wir hosten Plausible ausschlie&szlig;lich auf unseren eigenen
